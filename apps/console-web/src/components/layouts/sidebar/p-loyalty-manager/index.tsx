...
import { HouseSvg, LoyaltySvg, SettingsSvg } from "../../../../assets/sidebar";
...
const menuItems: MenuItem[] = [
  {
    ...
    icon: LoyaltySvg,
    subItems: [
      { text: "Dashboard", route: ROUTES.PLATFORM_MANAGER_LOYALTY },
      { text: "Users", route: `${ROUTES.USERS}` },
      { text: "Cashback", route: `${ROUTES.TIERS}` },
      {
        text: "Referral Rewards",
        route: `${ROUTES.LOYALTY}?type=referral-rewards`,
      },
      {
        text: "Promo Codes",
        route: `${ROUTES.LOYALTY}?type=promo-codes`,
      },
    ],
  },
...
export const PlatformLoyaltyManagerSidebar: React.FC<SidebarProps> = () => {
